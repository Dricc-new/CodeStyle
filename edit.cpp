...
wxBEGIN_EVENT_TABLE (Edit, wxStyledTextCtrl)
    ...
    //(wxID_ANY,Edit::onfuncion)
    EVT_KEY_DOWN( Edit::OnKeyDown )


wxEND_EVENT_TABLE()

void Edit::onfuncion(wxStyledTextEvent &event){
    AutoCompShow(0,_("show?0"));
}
...
Edit::Edit (wxWindow *parent, wxWindowID id,
    ...
    StyleSetForeground (wxSTC_STYLE_DEFAULT, wxColor(150,150,150));
    StyleSetBackground (wxSTC_STYLE_DEFAULT, wxColor(24,24,32));
    StyleSetForeground (wxSTC_STYLE_LINENUMBER, white2);
    StyleSetBackground (wxSTC_STYLE_LINENUMBER, black2);
    StyleSetForeground(wxSTC_STYLE_INDENTGUIDE, wxColour ("DARK GREY"));
    InitializePrefs (DEFAULT_LANGUAGE);
    this->SetCaretForeground(wxColor(200,200,200));
    // set visibility
    ...
    wxColor white(150,150,150);
    SetFoldMarginHiColour(true,black);
    SetFoldMarginColour(true,black);
    MarkerDefine (wxSTC_MARKNUM_FOLDER,        wxSTC_MARK_BOXPLUS,  black, white);
    MarkerDefine (wxSTC_MARKNUM_FOLDEROPEN,    wxSTC_MARK_BOXMINUS, black, white);
    MarkerDefine (wxSTC_MARKNUM_FOLDERSUB,     wxSTC_MARK_VLINE,    black, white);
    MarkerDefine (wxSTC_MARKNUM_FOLDEREND,     wxSTC_MARK_BOXPLUS,  black, white);
    MarkerDefine (wxSTC_MARKNUM_FOLDEROPENMID, wxSTC_MARK_BOXMINUS, black, white);
    MarkerDefine (wxSTC_MARKNUM_FOLDERMIDTAIL, wxSTC_MARK_TCORNER,  black, white);
    MarkerDefine (wxSTC_MARKNUM_FOLDERTAIL,    wxSTC_MARK_LCORNER,  black, white);
    ...
    RegisterImage(0, bmp);
    wxBitmap bmp2(hashtag_xpm2);
    RegisterImage(1, bmp2);
    ...
    // miscellaneous
    m_LineNrMargin = TextWidth (wxSTC_STYLE_LINENUMBER, "_9999999");
...
void Edit::OnCharAdded (wxStyledTextEvent &event) {
    ...
    if (chr == '\n') {
        ...
        wxString s = "define?1 elif?0 else?0 endif?0 error?0 if?0 ifdef?0 "
    ...
    //AutoCompShow(0,GetCurLine());
    //if(buff.length()>2)AutoCompShow(buff.length(),textt);
}
...
bool Edit::InitializePrefs (const wxString &name) {
    ...
    StyleSetForeground (wxSTC_STYLE_LINENUMBER, wxColor(120,120,120));
    StyleSetBackground (wxSTC_STYLE_LINENUMBER, wxColor(32,32,45));
    SetMarginWidth (m_LineNrID, m_LineNrMargin); // start out not visible

    // annotations style
    StyleSetBackground(ANNOTATION_STYLE, wxColor(24,24,32));
    ...
    // set common styles
    StyleSetForeground (wxSTC_STYLE_DEFAULT,wxColor(24,24,32));
    StyleSetForeground (wxSTC_STYLE_INDENTGUIDE, wxColor(24,24,32));
    ...
    if (g_CommonPrefs.syntaxEnable) {
        ...
        for (Nr = 0; Nr < STYLE_TYPES_COUNT; Nr++) {
            ...
            StyleSetForeground (Nr, wxColor(curType.foreground[0],curType.foreground[1],curType.foreground[2]));
            StyleSetBackground (Nr, wxColor(curType.background[0],curType.background[1],curType.background[2]));
